...
<head>
    ...
    <!-- Favicons (Update paths or remove if unnecessary) -->
  ...
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">TFF</h5>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="donate.php">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="announcement.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Manage announcement</h1>
    ...
    <span id="current-date">Loading...</span>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-4" style="margin-left: 15px; width: 100%; padding-top: 20px;">
